...
[Awesome SciML](https://github.com/MartinuzziFrancesco/awesome-scientific-machine-learning?tab=readme-ov-file)([Stochastic Differential Equations{SDE} Courses](https://math.stackexchange.com/questions/3949903/recommendation-for-good-online-videos-for-stochastic-differential-equations){[Black & Scholes Model for Options Trading](https://www.investopedia.com/terms/b/blackscholes.asp)} is actually a partial SDE & lots of complex probabilistic/stochastic scientific/engineering apps can be simulated/modelled as an SDE - the main idea is to come up with the form & parameter values of the SDE{the model} using SciML & then using the model to predict/generate future values{using solvers}, an idea similar to normal ML})    
...
[Bentley Systems' itwin](https://www.businesswire.com/news/home/20221115005145/en/Bentley-Systems-Launches-iTwin-Experience-iTwin-Capture-and-iTwin-IoT-to-Extend-iTwin-Platform)([itwin.js](https://www.itwinjs.org/), [Building Industrial Digital Twins](https://www.packtpub.com/product/building-industrial-digital-twins/9781839219078) & [Hands-On Azure Digital Twins](https://www.packtpub.com/product/hands-on-azure-digital-twins/9781801071383))   
