...
[Applied Deep Learning and Computer Vision for Self Driving Cars](https://www.packtpub.com/product/applied-deep-learning-and-computer-vision-for-self-driving-cars/9781838646301) & [Hands-On Vision and Behavior for Self-Driving Cars](https://www.packtpub.com/en-in/product/hands-on-vision-and-behavior-for-self-driving-cars-9781800203587)(In my eyes, Self Driving cars are just robots which uses sensory, visual & location data to know its environment better & then use (maybe RL{Reinforcement Learning} based) path planning & to actually move via that path(the control part), uses actuators - its kind of old wine{Robotics} in a new bottle{Self Driving cars})         
