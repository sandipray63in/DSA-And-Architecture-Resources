...
[Grokking Deep Learning](https://www.manning.com/books/grokking-deep-learning)(people from Electronics{& Communication} background might have had a subject called Feedback Control Systems/Theory & the concepts in that subject is also quite similar to Forward/Back Propagation)        
...
[Applied Deep Learning and Computer Vision for Self Driving Cars](https://www.packtpub.com/product/applied-deep-learning-and-computer-vision-for-self-driving-cars/9781838646301) & [Hands-On Vision and Behavior for Self-Driving Cars](https://www.packtpub.com/en-in/product/hands-on-vision-and-behavior-for-self-driving-cars-9781800203587)(In my eyes, Self Driving cars are robots which uses sensory, visual & location data to know its environment better & then use {maybe RL{Reinforcement Learning} based} path planning & to actually move via that path(the control part), uses actuators - its kind of old wine{Robotics} in a new bottle{Self Driving cars} - people from Electronics{& Communication} background might have had a subject called Feedback Control Systems/Theory & the concepts in that subject is also quite in alignmemnt with Slef Driving Cars{& Robotics in general})         
