...
[How Drones are Used in Inspections](https://www.flyability.com/drone-inspections)(e.g. Infrstructure Software Based Comps{e.g. Bentley Systems} uses Drones to capture images of infrastructures & then produces/reconstructs a 3d model {a Digital Twin built using 3D Reconstruction techniques - Bentley Systems calls it "Reality Capture" by the way} & then can build a VR based interface of the 3D Model to be viewed/monitored by analysts)         
